curl -X POST http://localhost:7000/ --data-urlencode "To=+1234567890" --data-urlencode "From=+1987654321" --data-urlencode "Body=2025-06-10"
...
#curl -X POST http://localhost:7000/ --data-urlencode "To=+1234567890" --data-urlencode "From=+1987654324" --data-urlencode "Body=dfss 1"
